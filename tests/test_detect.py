...
class TestDetect(ScarletTestCase):
    ...
    def test_get_footprints(self):
        ...
        assert_array_equal(footprints[0].footprint, self.sources[3].data > 1e-15)
        ...
        truth = self.sources[0] + self.sources[1]
        assert_array_equal(footprints[1].footprint, truth.data > 1e-15)
        ...
        assert_array_equal(footprints[2].footprint, self.sources[2].data > 1e-15)
    ...
    def test_footprint(self):
        ...
        truth = self.sources[0] + self.sources[1]
        truth.data[truth.data < 1e-15] = 0
        image = scarlet_footprints_to_image([footprint1, footprint2], truth.shape)
